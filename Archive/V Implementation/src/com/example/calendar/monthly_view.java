...
public class monthly_view extends Activity implements OnClickListener
	{
		private static final String tag = "monthly_view";
		...
		private static int trailingSpaces = 0;
		...
		public void onCreate(Bundle savedInstanceState)
			{
				...
				selectedDayMonthYearButton.setText("Selecting: "); //bottun indicates the current value.
				...
				private void printMonth(int mm, int yy)
					{
						...
						int leadSpaces = 0;
						int daysInPrevMonth = 0;   // 28,30, 31 days in a month.
						int prevMonth = 0;
						int prevYear = 0;
						int nextMonth = 0;
						int nextYear = 0;
				...
				public View getView(int position, View convertView, ViewGroup parent)
					{
						...
						if (position == currentDayOfMonth+trailingSpaces-1)   //shift the day according to the previous month tails.
							{
								gridcell.setTextColor(Color.RED);  // the color of the reference day
							}
